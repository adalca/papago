...
#
# examples
# ./sgeSubvol2diagLSwgmm.sh ADNI_T1_baselines mar12_2016 Ds5Us5Reg wholevol LS_K5_dec02
...
# command shell file
mccSh="${CLUST_PATH}MCC_mccSubvol2diagLSwgmm/run_mccSubvol2diagLSwgmm.sh"
