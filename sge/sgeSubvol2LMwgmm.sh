...
#
# examples
# ./sgeSubvol2LMwgmm.sh ADNI_T1_baselines mar12_2016 Ds5Us5Reg wholevol LM_K5_nov29 <5>
...
# command shell file
mccSh="${CLUST_PATH}MCC_mccSubvol2LMwgmm/run_mccSubvol2LMwgmm.sh"
...
do
  ...
  sgerunfile="${sgeopath}/subvol2LMwgmm_${subvolInd}.sh"
