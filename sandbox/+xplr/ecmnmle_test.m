...
gmdistDs = fitgmdist(X0, gmmK, 'regularizationValue', regVal, 'replicates', 3, 'Options', gmmopt);
tic;
dfn = @(w) diag(0.0001*(exp(-10*(w-1)) - 0.99));
W = bucknerDsMaskPatchCol + 0.0000001;
wgsc = wgmmfit(X0, W, gmmK, 'model4fn', dfn,  'replicates', 3, 'initmethod', 'model4exp05', 'regularizationValue', 0, 'TolFun', -inf, 'MaxIter', 5, 'initmethod', 'gmm', 'initmethodArgs', {gmdistDs});
