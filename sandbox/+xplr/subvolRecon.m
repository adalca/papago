...
fnames = fullfile(SYNTHESIS_DATA_PATH, 'buckner', 'md', [sys.usrname, '_restor_md_*']);
bucknermd = loadmd(fnames);
...
fnames = fullfile(SYNTHESIS_DATA_PATH, 'adni', 'md', [sys.usrname, '_restor_md_*']);
adnimd = loadmd(fnames);
